...
| **R5** | **Target Ambíguo** | Science | 2 | 3 | **6** | Definição formal registrada + validações por safra. |
| **R6** | **Vazamento Temporal (*Leakage*)** | Science | 2 | 3 | **6** | Split temporal + features anteriores ao target + checklist DS obrigatório. |
...
| **R10** | Perda de metadados de experimentos (MLflow) | Data Science | 1 | 2 | **2** | Backup periódico do volume Docker onde residem os artefatos do MLflow. |
