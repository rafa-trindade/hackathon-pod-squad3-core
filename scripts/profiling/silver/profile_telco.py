...
SILVER_BASE_PATH = "s3://lake/silver/telco"
...
md_file = init_md_report(
    report_filename="silver_telco_profiling.md",
    dataset_name=f"silver/telco` - `{latest_run_id}",
    layer="silver"
)
...
md = "### 🔑 Garantia de Unicidade: `silver/telco`\n"
...
md = "### 📊 Schema e Estatísticas: `silver/telco`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Range de Datas: `silver/telco`\n"
...
##################################################
md = "### 🔢 Range de Valores Numéricos: `silver/telco`\n\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `silver/telco`\n"
