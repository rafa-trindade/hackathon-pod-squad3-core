...
SILVER_BASE_PATH = "s3://lake/silver/recarga"
...
md_file = init_md_report(
    report_filename="silver_recarga_profiling.md",
    dataset_name=f"silver/recarga` - `{latest_run_id}",
    layer="silver"
)
...
#####################################################
chave_tecnica_cols = ["num_cpf", "dat_insercao_credito", "hor_insercao_credito"]

md = "### 🔑 Garantia de Unicidade: `silver/recarga`\n"
...
md = "### 📊 Schema e Estatísticas: `silver/recarga`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Range de Datas: `silver/recarga`\n"
...
##################################################
md = "### 🔢 Range de Valores Numéricos: `silver/recarga`\n\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `silver/recarga`\n"
