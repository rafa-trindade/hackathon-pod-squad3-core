...
SILVER_BASE_PATH = "s3://lake/silver/pagamento"
...
md_file = init_md_report(
    report_filename="silver_pagamento_profiling.md",
    dataset_name=f"silver/pagamento` - `{latest_run_id}",
    layer="silver"
)
...
md = "### 🔑 Garantia de Unicidade: `silver/pagamento`\n"
...
md = "### 📊 Schema e Estatísticas: `silver/pagamento`\n"
...
# VOLUMETRIA #####################################
##################################################
md = "### 📦 Volumetria: `silver/pagamento`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Range de Datas: `silver/pagamento`\n"
...
##################################################
md = "### 🔢 Range de Valores Numéricos: `silver/pagamento`\n\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `silver/pagamento`\n"
