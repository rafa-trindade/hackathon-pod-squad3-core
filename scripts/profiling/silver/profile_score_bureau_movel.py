...
SILVER_BASE_PATH = "s3://lake/silver/score_bureau_movel"
...
latest_run_id = con.execute(f"""
    ...
    FROM read_parquet(
        '{SILVER_BASE_PATH}/run_id=*/**/*.parquet',
        hive_partitioning=1
    )
""").fetchone()[0]
...
md_file = init_md_report(
    report_filename="silver_score_bureau_movel_profiling.md",
    dataset_name=f"silver/score_bureau_movel` - `{latest_run_id}",
    layer="silver"
)
...
md = "### 🔑 Garantia de Unicidade: `silver/score_bureau_movel`\n"
...
md = "### 📊 Schema e Estatísticas: `silver/score_bureau_movel`\n"
...
# VOLUMETRIA #####################################
##################################################
md = "### 📦 Volumetria: `silver/score_bureau_movel`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Range de Datas: `silver/score_bureau_movel`\n"
...
##################################################
md = "### 🔢 Range de Valores Numéricos: `silver/score_bureau_movel`\n\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `silver/score_bureau_movel`\n"
