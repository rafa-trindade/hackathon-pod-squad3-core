...
BRONZE_BASE_PATH = "s3://lake/bronze/dados_cadastrais"
...
md_file = init_md_report(
    report_filename="bronze_dados_cadastrais_profiling.md",
    dataset_name=f"bronze/dados_cadastrais` - `{latest_run_id}",
    layer="bronze"
)
...
#####################################################
chave_tecnica_cols = ["num_cpf", "safra"]

md = "### 🔑 Garantia de Unicidade: `bronze/dados_cadastrais`\n"
...
# VOLUMETRIA #####################################
##################################################
md = "### 📦 Volumetria: `bronze/dados_cadastrais`\n"
...
# SCHEMA #########################################
##################################################
md = "### 🧬 Schema: `bronze/dados_cadastrais`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Range de Datas: `bronze/dados_cadastrais`\n"
...
##################################################
md = "### 🔢 Range de Valores Numéricos: `bronze/dados_cadastrais`\n\n"
...
md = "### 📊 Estatísticas por Coluna: `bronze/dados_cadastrais`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `bronze/dados_cadastrais`\n"
