...
GOLD_BASE_PATH = "s3://lake/gold/abt_model_features"
...
md_file = init_md_report(
    report_filename="gold-abt_model_features-profiling.md",
    dataset_name=f"gold/abt_model_features` - `{latest_run_id}",
    layer="gold"
)
...
#############################################################
md = "### ⚙️ Sumário Técnico do Dataset: `abt_model_features`\n\n"
...
#############################################################
md = "### 🎯 Distribuição da Variável Alvo (Target): `abt_model_features`\n\n"
...
md = "### 🔑 Verificação de Chave Técnica: `abt_model_features`\n"
...
#############################################################
md = "### 🔍 Perfil de Missings por Feature: `abt_model_features`\n\n"
...
#############################################################
md = "### 🚩 Detecção de Anomalias Financeiras (Outliers > 3σ): `abt_model_features`\n\n"
...
# VOLUMETRIA #####################################
##################################################
md = "### 📦 Volumetria: `abt_model_features`\n"
