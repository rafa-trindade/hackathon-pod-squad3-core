...
path_parquet = "s3://lake/raw/score_bureau_movel/*.parquet"

md_file = init_md_report(
    report_filename="raw_score_bureau_movel_profiling.md",
    dataset_name="raw/score_bureau_movel",
    layer="raw"
)
...
##################################################
md = "### 📦 Volume Físico Parquet: `raw/score_bureau_movel`\n"
...
# VOLUMETRIA LÓGICA ##############################
##################################################
md = "### 🔢 Volume Lógico: `raw/score_bureau_movel`\n"
