...
path_parquet = "s3://lake/raw/recarga/*.parquet"

md_file = init_md_report(
    report_filename="raw_recarga_profiling.md",
    dataset_name="raw/recarga",
    layer="raw"
)
...
##################################################
md = "### 📦 Volume Físico Parquet: `raw/recarga`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `raw/recarga`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `raw/recarga`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `raw/recarga`\n"
