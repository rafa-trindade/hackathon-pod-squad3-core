...
path_parquet = "s3://lake/raw/pagamento/*.parquet"

md_file = init_md_report(
    report_filename="raw_pagamento_profiling.md",
    dataset_name="raw/pagamento",
    layer="raw"
)
...
##################################################
md = "### 📦 Volume Físico Parquet: `raw/pagamento`\n"
...
# VOLUMETRIA LÓGICA ##############################
##################################################
md = "### 🔢 Volume Lógico: `raw/pagamento`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Campos de Data: `raw/pagamento`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `raw/pagamento`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `raw/pagamento`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `raw/pagamento`\n"
