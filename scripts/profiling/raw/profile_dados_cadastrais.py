...
path_parquet = "s3://lake/raw/dados_cadastrais/*.parquet"

md_file = init_md_report(
    report_filename="raw_dados_cadastrais_profiling.md",
    dataset_name="raw/dados_cadastrais",
    layer="raw"
)
...
##################################################
md = "### 📦 Volume Físico Parquet: `raw/dados_cadastrais`\n"
...
# VOLUMETRIA LÓGICA ##############################
##################################################
md = "### 🔢 Volume Lógico: `raw/dados_cadastrais`\n"
...
# SCHEMA #########################################
##################################################
md = "### 🧬 Schema: `raw/dados_cadastrais`\n"
...
# CAMPOS DATE/TIME ###############################
##################################################
md = "### 📅 Campos de Data: `raw/dados_cadastrais`\n"
...
##################################################
md = "### 📊 Estatísticas por Coluna: `raw/dados_cadastrais`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `raw/dados_cadastrais`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `raw/dados_cadastrais`\n"
