...
path_parquet = "s3://lake/raw/telco/*.parquet"

md_file = init_md_report(
    report_filename="raw_telco_profiling.md",
    dataset_name="raw/telco",
    layer="raw"
)
...
##################################################
md = "### 📊 Estatísticas por Coluna: `raw/telco`\n"
...
##################################################
md = "### 🔟 Distribuição de Valores (Top 10): `raw/telco`\n"
...
# STRINGS: MED, MIN, MÁX #########################
##################################################
md = "### 📏 Comprimento de Strings: `raw/telco`\n"
